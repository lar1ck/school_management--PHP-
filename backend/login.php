...
<body class=" bg-gray-950  text-whitebg-gray-950 flex items-center justify-center h-screen">
    <div class="bg-gray-900 border border-gray-700 rounded-lg p-8 w-96">
        ...
        <form action="login.php" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <select name="role" class="w-full p-2 border border-gray-700 bg-gray-800  text-white rounded-md focus:ring focus:ring-blue-300 outline-none" required>
            ...
            <div>
                ...
                <input type="text" name="username" placeholder="Enter your username"
                    class="w-full p-2 border border-gray-700 bg-gray-800  text-white rounded-md focus:ring focus:ring-blue-300 outline-none" required>
            </div>
